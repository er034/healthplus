...
<div>
    ...
    if(isset($_SESSION['benutzer'])):
        ...
        if($page == 'anmelden'):
            echo 'Doch <a href="indexalt.phpphp?page=registrieren">registrieren</a>?';
            require_once('anmelden.php');
        elseif($page == 'registrieren'):
            echo 'Doch <a href="indexalt.php?page=anmelden">anmelden</a>?';
            require_once('registrieren.php');
        else:
            echo 'Hey! Willst du dich <a href="indexalt.php?page=anmelden">anmelden</a> oder <a href="registrieren.php">registrieren</a>?';
        endif;
    endif;
    ?>
    </section>
