...
<head>
    ...
    <title>HEALTH PLUS | Datenschutz</title>
</head>
...
<div class="page-content mt-5 text-center">
    <div class="legal-notice">
        <p>
            <strong>WAS MACHEN WIR MIT DEINEN INFORMATIONEN?</strong>
        </p>
        <p>
            Wenn du etwas aus unserem Shop kaufst, behalten wir deine persönliche Informationen wie Name, Adresse und Email-Adresse <br> als Teil des Kaufen und Verkaufen Prozesses.
            Wenn du unseren Shop durchstöberst, erhalten wir automatisch die IP Adresse <br> deines Computers um uns Informationen zu geben um mehr über deinen Browser oder Betriebssystem zu erfahren.
        </p>
        <p>
            <strong>SICHERHEIT?</strong>
        </p>
        <p>
            Wir unternehmen alle nötigen Vorsichtsmaßnahmen und folgen den gängigen Best Practices der Branche um <br>deine persönlichen Daten zu schützen und um sicherzustellen,
            dass diese nicht auf eine unangemessene <br> Weise verloren, missbraucht, konsultiert, veröffentlicht, geändert oder gelöscht werden.
        </p>
