...
<head>
    ...
    <link rel= "stylesheet" href="style_produkt.css" type="text/css">
</head>
<div>
    <header>
        <div class="container">
    ...
    <section id="boxes">
        <div class="container">
        <div class="box">
            <img src="bilder/item_01.png" width="300px" height="450px" border="0" alt="Item">
        </div>
    </section>
    ...
    <section id="select">
        <div class="container">
            <form action="/....">
                <select name="Wähle Deine Größe">
                    <option value="300g">Pure Oats (300g)</option>
                    <option value="600g">Pure Oats (600g)</option>
                    <option value="1000g">Pure Oats (10000g)</option>
                </select>
                <input type="submit" value="JETZT AUSWÄHLEN">
            </form>
        </div>
    </section>
    <!-- Suchfunktion für den Online Shop -->
