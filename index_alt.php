...
<head>
    ...
    <link rel= "stylesheet" href="style_index_alt.css" type="text/css">
</head>
...
<!-- Header02 beinhaltet alle Login und Registrieren Elemente-->
    <section id="header">
        ...
        Möchtest Du dich  <a href="/~er034/Login%20-%20System/login.php">anmelden</a> oder <a href="/~er034/Login%20-%20System/register.php">registrieren</a>?
            ...
            <?php  if (isset($_SESSION['username'])) : ?>
                <p>Willkommen zurück, <strong><?php echo $_SESSION['username']; ?></strong> <button> <a href="index_alt.php?logout='1'">LOGOUT</a> </button></p>
            <?php endif ?>
    </section>
    ...
    <div class="menu">
        <div id="logo">
            <a href="index_alt.php"><img src="bilder/logo.png" alt="Logo"></a>
        </div>
